...
public class ServerItem {
    public static ServerItem get(String item_id) {
        return ServerItemDao.getInstance().get(item_id);
    }
    ...
    public ServerItem(String item_id, String item_name, String material_name, String category) {
        this(
                item_id,
    ...
    public ServerItem(String item_id, Component item_name, Material material, ItemCategory category) {
